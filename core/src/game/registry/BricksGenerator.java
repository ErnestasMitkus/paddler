...
public class BricksGenerator {
    ...
    private static Platform createPlatform(Vector2 platformPosition, Vector2 platformSize, World world, TextureAtlas atlas) {
        Body platformBody = PlatformSpawner.spawnPlatform(world, platformPosition, platformSize);
        return new Platform(platformBody, platformSize.cpy().mul(PPM_MAT), atlas, SpriteRegistry.BLUE_TILE, SpriteRegistry.BLUE_TILE_DAMAGED);
    }
}
